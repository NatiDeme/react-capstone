...
function agility() {
  const heroes = useSelector((state) => state.agilityHeroReducer.heroes);
  ...
  return (
    <>
      <div className="bg-my-light-blue flex gap-6 items-center pl-10">
        <img src={agile} alt="Dota logo" className="h-36 opacity-95" />
        <div className="text-white">
          <p className="font-black text-3xl">Agility</p>
          <p>
            { heroes.length }
            {' '}
            Heros
